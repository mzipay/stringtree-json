...
public class JSONWriterMapTest extends JSONTestCase {
    ...
    public void testMultiple() {
        ...
        assertMap("{\"goodbye\":\"cruel\",\"hello\":\"world\"}");
    }

    public void testMixed() {
        map.put("hello", "world");
        map.put("goodbye", Integer.valueOf(123));
        assertMap("{\"goodbye\":123,\"hello\":\"world\"}");
    }

    public void testNestedMap() {
        Map<String, Object> child = new TreeMap<String, Object>();
        child.put("whetever", "abc");
        child.put("X Y", Boolean.FALSE);
        map.put("hello", "world");
        map.put("goodbye", child);
        assertMap("{\"goodbye\":{\"X Y\":false,\"whetever\":\"abc\"},\"hello\":\"world\"}");
    }
    ...
    public void testNestedArray() {
        ...
        map.put("hello", "world");
        map.put("goodbye", child);
        assertMap("{\"goodbye\":[123,456],\"hello\":\"world\"}");
    }
